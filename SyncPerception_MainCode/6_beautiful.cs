...
public class PredictBeautifulComponent : GH_Component
{
    ...
    public PredictBeautifulComponent()
        : base("Predict Beautiful", "PredBea",
    ...
    protected override Bitmap Icon
    {
       get
       {
           ...
           var resourceName = "PythonEnvChecker.Resources.bea.png"; 
    ...
    {
        pManager.AddNumberParameter("Beautiful=0", "P0", "Predicted probability for class 0", GH_ParamAccess.item);
        pManager.AddNumberParameter("Beautiful=1", "P1", "Predicted probability for class 1", GH_ParamAccess.item);
        pManager.AddNumberParameter("Beautiful=2", "P2", "Predicted probability for class 2", GH_ParamAccess.item);
        pManager.AddNumberParameter("Beautiful=3", "P3", "Predicted probability for class 3", GH_ParamAccess.item);
        pManager.AddNumberParameter("Beautiful=4", "P4", "Predicted probability for class 4", GH_ParamAccess.item);
    }
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
        ...
        using (Py.GIL())
        {
            try
            {
                ...
                string scriptDirectory = Path.GetDirectoryName(@"D:\CV+GNN\application\gh_plugin_VS\PythonEnvChecker\pythoncode\6_pre_bea.py");
                sys.path.append(scriptDirectory);

                
                dynamic PredictWea = Py.Import("6_pre_bea");
    ...
    public override Guid ComponentGuid => new Guid("78dffa91-5764-4362-961e-7e4882cffaaf");
}