...
public class PredictLivelyComponent : GH_Component
{
    ...
    public PredictLivelyComponent()
        : base("Predict Lively", "PredLive",
    ...
    protected override Bitmap Icon
    {
       get
       {
           ...
           var resourceName = "PythonEnvChecker.Resources.live.png";  
    ...
    {
        pManager.AddNumberParameter("Lively=0", "P0", "Predicted probability for class 0", GH_ParamAccess.item);
        pManager.AddNumberParameter("Lively=1", "P1", "Predicted probability for class 1", GH_ParamAccess.item);
        pManager.AddNumberParameter("Lively=2", "P2", "Predicted probability for class 2", GH_ParamAccess.item);
        pManager.AddNumberParameter("Lively=3", "P3", "Predicted probability for class 3", GH_ParamAccess.item);
        pManager.AddNumberParameter("Lively=4", "P4", "Predicted probability for class 4", GH_ParamAccess.item);
    }
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
        ...
        using (Py.GIL())
        {
            try
            {
                ...
                string scriptDirectory = Path.GetDirectoryName(@"D:\CV+GNN\application\gh_plugin_VS\PythonEnvChecker\pythoncode\6_pre_live.py");
                sys.path.append(scriptDirectory);

                 
                dynamic PredictWea = Py.Import("6_pre_live");
    ...
    public override Guid ComponentGuid => new Guid("7f3ab642-f498-458f-8f9a-59018bd294df");
}