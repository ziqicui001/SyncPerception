...
def process_single_file(image_path, csv_path, output_folder):
    ...
    logging.info(f"新CSV文件已保存到 {output_csv_path}")

    return output_csv_path


def process_files(image_paths, csv_paths, output_folder):
    """
    批量处理多个图像和 CSV 文件
    """
    ...
    for image_path, csv_path in zip(image_paths, csv_paths):
        output_csv_path = process_single_file(image_path, csv_path, output_folder)
