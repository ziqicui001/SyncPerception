...
public class PredictBoringComponent : GH_Component
{
    ...
    public PredictBoringComponent()
        : base("Predict Boring", "PredBor",
    ...
    protected override Bitmap Icon
    {
       get
       {
           ...
           var resourceName = "PythonEnvChecker.Resources.bor.png"; 
    ...
    {
        pManager.AddNumberParameter("Boring=0", "P0", "Predicted probability for class 0", GH_ParamAccess.item);
        pManager.AddNumberParameter("Boring=1", "P1", "Predicted probability for class 1", GH_ParamAccess.item);
        pManager.AddNumberParameter("Boring=2", "P2", "Predicted probability for class 2", GH_ParamAccess.item);
        pManager.AddNumberParameter("Boring=3", "P3", "Predicted probability for class 3", GH_ParamAccess.item);
        pManager.AddNumberParameter("Boring=4", "P4", "Predicted probability for class 4", GH_ParamAccess.item);
    }
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
        ...
        using (Py.GIL())
        {
            try
            {
                ...
                string scriptDirectory = Path.GetDirectoryName(@"D:\CV+GNN\application\gh_plugin_VS\PythonEnvChecker\pythoncode\6_pre_bor.py");
                sys.path.append(scriptDirectory);

                
                dynamic PredictWea = Py.Import("6_pre_bor");
    ...
    public override Guid ComponentGuid => new Guid("e73051bb-5067-4063-a972-345639a5bd64");
}