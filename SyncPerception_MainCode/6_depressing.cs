...
public class PredictDepressingComponent : GH_Component
{
    ...
    public PredictDepressingComponent()
        : base("Predict Depressing", "PredDep",
    ...
    protected override Bitmap Icon
    {
       get
       {
           ...
           var resourceName = "PythonEnvChecker.Resources.dep.png"; 
    ...
    {
        pManager.AddNumberParameter("Depressing=0", "P0", "Predicted probability for class 0", GH_ParamAccess.item);
        pManager.AddNumberParameter("Depressing=1", "P1", "Predicted probability for class 1", GH_ParamAccess.item);
        pManager.AddNumberParameter("Depressing=2", "P2", "Predicted probability for class 2", GH_ParamAccess.item);
        pManager.AddNumberParameter("Depressing=3", "P3", "Predicted probability for class 3", GH_ParamAccess.item);
        pManager.AddNumberParameter("Depressing=4", "P4", "Predicted probability for class 4", GH_ParamAccess.item);
    }
    ...
    protected override void SolveInstance(IGH_DataAccess DA)
    {
        ...
        using (Py.GIL())
        {
            try
            {
                ...
                string scriptDirectory = Path.GetDirectoryName(@"D:\CV+GNN\application\gh_plugin_VS\PythonEnvChecker\pythoncode\6_pre_dep.py");
                sys.path.append(scriptDirectory);

                
                dynamic PredictWea = Py.Import("6_pre_dep");
    ...
    public override Guid ComponentGuid => new Guid("19df6b2a-28d9-4e0b-acef-4ea25fa920ce");
}